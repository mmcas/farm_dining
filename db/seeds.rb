...
ingr = Ingredient.new(name:'carrot',description:'Mixed colored carrots, fresh from the land, Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ultrices eros vel augue vulputate, nec. ',main_category:'Fruit & Vegetables',category:'Carrots',price:500,rating:1,sku:'1',farm_id:farm1.id,  available_quantity:20,price_type:'per kg',  remote_photo_url: cl_image_path('harshal-s-hirve-44494-unsplash.jpg'))
ingr.save!
ingr = Ingredient.new(name:'Dried Chickpeas',description:'chickpeas dried Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ultrices eros vel augue vulputate, nec. ',main_category:'Grains & Legumes',category:'Legumes',price:50,rating:1,sku:'3',farm_id:farm1.id,  available_quantity:20,price_type:'per kg',  remote_photo_url: cl_image_path('pexels-photo-273838.jpg'))
ingr.save!
ingr = Ingredient.new(name:'Steak',description:'Fresh Beef  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ultrices eros vel augue vulputate, nec. ',main_category:'Meat',category:'Beef',price:50,rating:1,sku:'5',farm_id:farm1.id,  available_quantity:30,price_type:'per kg',  remote_photo_url: cl_image_path('pexels-photo-112781.jpg'))
ingr.save!
ingr = Ingredient.new(name:'Chicken Eggs',description:'Wheat  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ultrices eros vel augue vulputate, nec. ',main_category:'Dairy & Eggs',category:'Eggs',price:50,rating:1,sku:'6',farm_id:farm1.id,  available_quantity:20,price_type:'Per 20',  remote_photo_url: cl_image_path('Metal-easter-eggs-basket.jpg'))
ingr.save!
...
ingr.save!
ingr = Ingredient.new(name:'Old Farmers Cheese',description:'The best and very tasty cheese  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ultrices eros vel augue vulputate, nec. ',main_category:'Dairy & Eggs',category:'Cheese',price:50,rating:1,sku:'10',farm_id:farm2.id,  available_quantity:20,price_type:'per kg',  remote_photo_url: cl_image_path('Pexels-photo-277276.jpg'))
ingr.save!
ingr = Ingredient.new(name:'Potato',description:'all potatoes',main_category:'Fruit & Vegetables',category:'Vegetables',price:50,rating:1,sku:'11',farm_id:farm3.id,  available_quantity:30,price_type:'per kg',  remote_photo_url: cl_image_path('Potatoes-vegetables-erdfrucht-bio-144248.jpg'))
ingr.save!
ingr = Ingredient.new(name:'Corn',description:'Corny Corn lorem ipsum lorem loriadad',main_category:'Grains & Legumes',category:'Grains',price:50,rating:1,sku:'12',farm_id:farm3.id,  available_quantity:20,price_type:'per kg',  remote_photo_url: cl_image_path('Pexels-photo-206653.jpg'))
ingr.save!
ingr = Ingredient.new(name:'Smocked Speck',description:'Speck ',main_category:'Meat',category:'Porc',price:50,rating:1,sku:'13',farm_id:farm3.id,  available_quantity:20,price_type:'per kg',  remote_photo_url: cl_image_path('Pexels-photo-306799.jpg'))
ingr.save!
ingr = Ingredient.new(name:'Cow-milk',description:'fresh raw cowmilk',main_category:'Dairy & Eggs',category:'Milk',price:50,rating:1,sku:'14',farm_id:farm3.id,  available_quantity:30,price_type:'per kg',  remote_photo_url: cl_image_path('Pexels-photo-248337.jpg'))
ingr.save!
ingr = Ingredient.new(name:'Fresh Yoghurt',description:'The best Goat’s milk yoghurt.  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ultrices eros vel augue vulputate, nec. ',main_category:'Dairy & Eggs',category:'Yoghurt',price:50,rating:1,sku:'15',farm_id:farm3.id,  available_quantity:30,price_type:'per kg',  remote_photo_url: cl_image_path('Pexels-photo-373882.jpg'))
ingr.save!
ingr = Ingredient.new(name:'Cabbage',description:'Cabbage cabbage lorem ipusm ',main_category:'Fruit & Vegetables',category:'Vegetables',price:50,rating:1,sku:'16',farm_id:farm3.id,  available_quantity:30,price_type:'per kg',  remote_photo_url: cl_image_path('Cabbage-vegetable-power-green.jpg'))
ingr.save!
...
ingr2 = Ingredient.new( name: "Sweet Strawberry"  ,description: "Sweet sweet taste  and colors"  ,
  ...
  available_quantity: 50, farm_id: farm1.id  ,price_type: "per kg",
