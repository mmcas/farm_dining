...
ingr.save!
ingr = Ingredient.new(name:'Sausages',description:'Very nice homemade sausages. Nice for Le Wagon dinners, all other combinations are perfect.',main_category:'Meat',category:'Porc',price:8,rating:4,sku:'9',farm_id:angela.id,  available_quantity:40,price_type:'Set(10)',  remote_photo_url: cl_image_path('meat-fridge-food-sausage-84267.jpg'))
ingr.save!
